      ...
      <aside class="sidebar" aria-label="Navegação da área do professor">
       <img src="img/logooficial.png" alt="Logo da Etec" class="logo-etec"></span><span class="brand-copy"><strong>Feira Tecnológica</strong><span>ETEC Maria Cristina Medeiros</span></span></a>
        ...
        <nav class="side-nav" aria-label="Navegação principal">
          ...
          <button class="active" type="button" data-page="avisos.php"><svg class="icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4"></path></svg>Avisos</button>
         ...
         <button type="button" data-page="centraldeajuda.php"><svg class="icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M4 5h16v14H4z"></path><path d="M8 9h8M8 13h5"></path> </svg><span>Fale Conosco</span></button></svg></button>
        </nav>
        </nav>
        <p class="sidebar-footer">Feira Tecnológica · 2026</p>
      </aside>
      <section class="content-column">
        <header class="topbar"><div><p class="eyebrow">COMUNICAÇÃO</p><h1>Avisos</h1><p>Mensagens institucionais relacionadas à Feira Tecnológica.</p></div><button class="notification-button" type="button" data-notification="Todos os avisos foram lidos." aria-label="Marcar avisos como lidos"><svg class="icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4"></path></svg><i class="notification-dot"></i></button></header>
        <section class="project-list"><div class="empty-state"><svg class="icon" aria-hidden="true" viewBox="0 0 24 24" style="width:27px;height:27px;margin-bottom:9px;color:var(--wine)"><path d="M4 5h16v12H4z"></path><path d="m7 9 3 2 3-2 3 2"></path><path d="M8 21h8"></path></svg><br>Não há novos avisos para você no momento.</div></section>
      </section>
